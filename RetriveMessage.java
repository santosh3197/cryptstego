...
public class RetriveMessage extends JInternalFrame implements ActionListener {
    ...
    public RetriveMessage(Steganograph stegano){
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==button[0]){
           ...
           retrive=new Retrive() ;
           operationStarted();
           boolean result=retrive.retriveMessage(f);
           operationComplete() ;
           if((filename.getText().length())>0){
               if(result){
                   txtMessage.setText(retrive.getMessage());
                   ...
                   JOptionPane.showMessageDialog(this, retrive.getMessage(),
                                             "Operation Failed",
