...
public class EmbedMessage extends JInternalFrame implements ActionListener, KeyListener {
    ...
    public EmbedMessage(Steganograph stegano) {
        super("Embed Message",
              false, //resizable
              true, //closable
              false, //maximizable
        ...
        steg = stegano;
        steg.win1_live = true;
        setFrameIcon(new ImageIcon("src/Steganography/resource/embed.gif"));
        ...
        if (ae.getSource() == button[0]) {
            ...
            if (validInput()) {
                ...
                if (result)
                    ...
                    JOptionPane.showMessageDialog(this, embed.getMessage(),
                                                  "Operation Failed",
    ...
    private boolean validInput() {
        ...
        if (txtMessage.getText().trim().length() <= 0) {
            JOptionPane.showMessageDialog(this, "Please key in the message!",
                                          "Message is empty.",
                                          JOptionPane.WARNING_MESSAGE);
            return false;
        }
