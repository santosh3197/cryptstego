...
public class RetriveFile extends JInternalFrame implements ActionListener{
    ...
    public RetriveFile(Steganograph stegano){
        super("Retrive File",
              false, //resizable
              true, //closable
              false, //maximizable
        ...
        if(ae.getSource()==button[0]){
            ...
            if((filename.getText().length())>0){
                ...
                if(result!="Failed"){
                    ...
                    JOptionPane.showMessageDialog(this, dmsg.getMessage(),
                                              "Operation Failed",
                                              JOptionPane.WARNING_MESSAGE);
                }
            }
            else
                JOptionPane.showMessageDialog(this,"Please select input file for Retrive Operation",
                                              "File field Empty",
                                              JOptionPane.INFORMATION_MESSAGE);
        }
