...
import Steganography.Steganograph;
import java.io.*;
import java.awt.*;
import javax.swing.*;
...
class Sender extends JInternalFrame implements ActionListener {
    ...
    public Sender (File file,Steganograph stegano) {
        super("Send File",
              false,           //resizable
              true,            //closable
              false,            //maximizable
        ...
        sendField.setForeground(new Color(0, 100, 255));
        sendField.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        fileField.setFont(new Font("Courier", Font.PLAIN, 14));
        fileField.setForeground(new Color(0, 100, 255));
